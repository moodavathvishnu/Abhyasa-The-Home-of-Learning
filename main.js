document.addEventListener('DOMContentLoaded', () => {
  ...
  const questions = {
    ...
    "Java":[
      { question: "Which keyword is used to create a class in Java?", options: [{ text: "class", image: null }, { text: "struct", image: null }, { text: "object", image: null }, { text: "define", image: null }], answer: "class", difficulty: "Easy", explanation: "In Java, the 'class' keyword is used to declare a class." },
      
      { question: "Which method is the entry point for any Java program?", options: [{ text: "start()", image: null }, { text: "main()", image: null }, { text: "run()", image: null }, { text: "init()", image: null }], answer: "main()", difficulty: "Easy", explanation: "The 'main()' method is the entry point of every Java application." },
      
      { question: "What is the default value of a boolean variable in Java?", options: [{ text: "true", image: null }, { text: "false", image: null }, { text: "0", image: null }, { text: "null", image: null }], answer: "false", difficulty: "Easy", explanation: "Boolean variables are initialized to 'false' by default in Java." },
      
      { question: "Which symbol is used to inherit a class in Java?", options: [{ text: "extends", image: null }, { text: "implements", image: null }, { text: "inherits", image: null }, { text: "instanceof", image: null }], answer: "extends", difficulty: "Easy", explanation: "In Java, 'extends' is used to inherit a class." },
      
      { question: "Which data type is used to store a single character in Java?", options: [{ text: "char", image: null }, { text: "String", image: null }, { text: "character", image: null }, { text: "int", image: null }], answer: "char", difficulty: "Easy", explanation: "The 'char' type is used to store a single character in Java." },
    
      { question: "What is the size of an int in Java?", options: [{ text: "2 bytes", image: null }, { text: "4 bytes", image: null }, { text: "8 bytes", image: null }, { text: "Depends", image: null }], answer: "4 bytes", difficulty: "Medium", explanation: "In Java, an int is always 4 bytes, independent of the platform." },
      
      { question: "Which keyword is used to prevent inheritance?", options: [{ text: "final", image: null }, { text: "private", image: null }, { text: "static", image: null }, { text: "sealed", image: null }], answer: "final", difficulty: "Medium", explanation: "Using 'final' on a class prevents it from being inherited." },
      
      { question: "What does JVM stand for?", options: [{ text: "Java Virtual Machine", image: null }, { text: "Java Variable Method", image: null }, { text: "Joint Virtual Machine", image: null }, { text: "Java Verified Mode", image: null }], answer: "Java Virtual Machine", difficulty: "Medium", explanation: "JVM stands for Java Virtual Machine, which runs Java bytecode." },
      
      { question: "Which operator is used to compare two values?", options: [{ text: "==", image: null }, { text: "=", image: null }, { text: "equals()", image: null }, { text: "compare()", image: null }], answer: "==", difficulty: "Medium", explanation: "In Java, '==' compares primitive data types." },
      
      { question: "What is the return type of the main() method?", options: [{ text: "void", image: null }, { text: "int", image: null }, { text: "String", image: null }, { text: "boolean", image: null }], answer: "void", difficulty: "Medium", explanation: "The 'main()' method returns 'void' because it does not return any value." },
    
      { question: "Which collection class allows duplicate elements?", options: [{ text: "HashSet", image: null }, { text: "TreeSet", image: null }, { text: "ArrayList", image: null }, { text: "LinkedHashSet", image: null }], answer: "ArrayList", difficulty: "Medium", explanation: "ArrayList allows duplicate elements, unlike Set implementations." },
      
      { question: "What is the superclass of all classes in Java?", options: [{ text: "Object", image: null }, { text: "Class", image: null }, { text: "Base", image: null }, { text: "Root", image: null }], answer: "Object", difficulty: "Medium", explanation: "In Java, 'Object' is the root superclass of all classes." },
      
      { question: "Which access modifier allows visibility only within the same package?", options: [{ text: "protected", image: null }, { text: "default", image: null }, { text: "private", image: null }, { text: "public", image: null }], answer: "default", difficulty: "Medium", explanation: "If no access modifier is specified, it is 'default', meaning package-private." },
      
      { question: "Which exception is thrown when a divided by zero occurs?", options: [{ text: "ArithmeticException", image: null }, { text: "NullPointerException", image: null }, { text: "IOException", image: null }, { text: "NumberFormatException", image: null }], answer: "ArithmeticException", difficulty: "Medium", explanation: "Division by zero results in an ArithmeticException in Java." },
    
      { question: "Which concept allows multiple methods with the same name but different parameters?", options: [{ text: "Overloading", image: null }, { text: "Overriding", image: null }, { text: "Inheritance", image: null }, { text: "Encapsulation", image: null }], answer: "Overloading", difficulty: "Medium", explanation: "Method Overloading means multiple methods with the same name but different parameters." },
      
      { question: "Which keyword is used to call a parent class constructor?", options: [{ text: "super", image: null }, { text: "this", image: null }, { text: "parent", image: null }, { text: "base", image: null }], answer: "super", difficulty: "Hard", explanation: "In Java, 'super()' is used to call a parent class's constructor." },
      
      { question: "What is the result of '5 + 2 + \"Hello\"' in Java?", options: [{ text: "7Hello", image: null }, { text: "Hello7", image: null }, { text: "Hello52", image: null }, { text: "Error", image: null }], answer: "7Hello", difficulty: "Hard", explanation: "In Java, 5 + 2 = 7, then 7 + \"Hello\" results in '7Hello' (string concatenation)." },
      
      { question: "Which type of polymorphism is achieved by method overriding?", options: [{ text: "Runtime", image: null }, { text: "Compile-time", image: null }, { text: "Static", image: null }, { text: "None", image: null }], answer: "Runtime", difficulty: "Hard", explanation: "Method overriding achieves runtime polymorphism in Java." },
      
      { question: "What does the 'instanceof' operator do?", options: [{ text: "Checks object type", image: null }, { text: "Creates object", image: null }, { text: "Deletes object", image: null }, { text: "Converts object", image: null }], answer: "Checks object type", difficulty: "Hard", explanation: "The 'instanceof' operator checks if an object is an instance of a specific class or subclass." },
      
      { question: "Which package contains the Scanner class?", options: [{ text: "java.util", image: null }, { text: "java.lang", image: null }, { text: "java.io", image: null }, { text: "java.awt", image: null }], answer: "java.util", difficulty: "Hard", explanation: "The Scanner class for input handling is present in the java.util package." }
    ],
    "Python":[
